        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            {posts.map((post) => (
              <div key={post.id} className="bg-white mb-6 shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4 text-sm">{post.date} | {post.author}</p>
            ...
            <div className="flex justify-between items-center mt-8">
              <button className="bg-gray-300 text-gray-700 px-4 py-2 rounded">Previous</button>
              <div className="hidden md:flex items-center space-x-2">
                <span className="px-2 py-1 bg-gray-200 text-gray-700 rounded">1</span>
                <span className="px-2 py-1 bg-gray-200 text-gray-700 rounded">2</span>
                <span className="px-2 py-1 bg-gray-200 text-gray-700 rounded">3</span>
                <span className="px-2 py-1 bg-gray-200 text-gray-700 rounded">4</span>
                <span className="px-2 py-1 bg-gray-200 text-gray-700 rounded">5</span>
              </div>
